				...
				<div class="container py-4 container-tight">
					<div class="mb-4 text-center">
						<a class="navbar-brand navbar-brand-autodark" href=".">
							<svg class="navbar-brand-image" height="32" viewBox="0 0 232 68" width="110" xmlns="http://www.w3.org/2000/svg">
								<path
								...
								<path clip-rule="evenodd"
									...
									fill-rule="evenodd" fill="#4a4a4a"></path>
							</svg>
						</a>
					</div>
						...
						<div class="card-body">
							...
							<form action="./" autocomplete="off" method="get" novalidate="">
								<div class="mb-3">
									...
									<input autocomplete="off" class="form-control" placeholder="your@email.com" type="email">
								</div>
								<div class="mb-2">
									...
									<div class="input-group input-group-flat">
										<input autocomplete="off" class="form-control" placeholder="Your password" type="password">
							...
							<div class="row">
								<div class="col">
									<a class="btn w-100" href="#">
										<svg class="icon icon-tabler icons-tabler-filled icon-tabler-brand-google" fill="currentColor" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
